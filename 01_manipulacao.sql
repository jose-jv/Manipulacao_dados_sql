...
--  2 - Insira o seguinte registro na tabela funcionarios:

select * from funcionarios;
insert into funcionarios (nome,cpf,data_nascimento,endereco,telefone,email,cargo,salario,data_admissao) values
('Ricardo Sousa', '111.222.333-44', '1992-05-12', 'Rua Harmonia 157, São Paulo', '11987651234', 'ricardo.sousa@email.com',
 'Chefe de Cozinha', 6000.00, '2019-03-15');
select * from funcionarios;

-- 3 - Insira os seguintes registros na tabela funcionarios:
insert into funcionarios (nome,cpf,data_nascimento,endereco,telefone,email,cargo,salario,data_admissao) values 
('Lívia Castro', '222.333.444-55', '1989-11-25', 'Av. Rebouças 1234, São Paulo', '11987653421', 'livia.castro@email.com',
 'Subgerente', 5500.00, '2019-06-20'),

('Marcos Lima', '333.444.555-66', '1985-04-17', 'Rua Augusta 2020, São Paulo', '11987655678', 'marcos.lima@email.com', 
'Barman', 2800.00, '2020-01-10'),

('Carla Mendes', '444.555.666-77', '1993-07-03', 'Av. Paulista 1853, São Paulo', '11987659876', 'carla.mendes@email.com',
 'Atendente', 2600.00, '2020-07-15'),

('Tiago Nunes', '555.666.777-88', '1978-08-12', 'Rua Funchal 500, São Paulo', '11987656789', 'tiago.nunes@email.com', 
'Sommelier', 3400.00, '2021-04-22'),

('Cláudia Vieira', '666.777.888-99', '1981-01-19', 'Alameda Lorena 1300, São Paulo', '11987657890', 'claudia.vieira@email.com', 
'Cozinheira', 3200.00, '2021-08-30'),

('Pedro Martins', '777.888.999-00', '1983-12-05', 'Rua dos Pinheiros 800, São Paulo', '11987658901', 'pedro.martins@email.com', 
'Garçom', 2700.00, '2022-03-15'),

('Fernanda Rocha', '888.999.000-11', '1990-09-27', 'Av. Faria Lima 1500, São Paulo', '11987659012', 'fernanda.rocha@email.com',
'Garçonete', 2700.00, '2022-05-20'),

('André Costa', '999.000.111-22', '1986-03-14', 'Rua Bela Cintra 985, São Paulo', '11987660123', 'andre.costa@email.com',
 'Gerente', 4700.00, '2022-10-10'),

('Sofia Alves', '000.111.222-33', '1995-06-01', 'Rua Consolação 1235, São Paulo', '11987661234', 'sofia.alves@email.com',
 'Recepcionista', 2400.00, '2023-01-01');
 
select * from funcionarios;

-- 4 - Insira o seguinte registro na tabela clientes:

select * from clientes;
insert into clientes (nome,cpf,data_nascimento,endereco,telefone,email,data_cadastro) values
 ('Lucas Silva', '123.456.789-01', '1990-01-15', 'Av. Brigadeiro Faria Lima, 1571, São Paulo', '11987651234',
 'lucas.silva@email.com', '2023-01-12');
 select * from clientes;
 
 -- 5 - Insira os seguintes registros na tabela clientes:
 insert into clientes (nome,cpf,data_nascimento,endereco,telefone,email,data_cadastro) values
...
('Priscila Ribeiro', '994.345.678-90', '1983-07-28', 'Rua Bandeira Paulista, 982, São Paulo', '11987680123', 'priscila.ribeiro@email.com', 
'2023-01-12');

select * from clientes;

-- 6 - Insira o seguinte registro na tabela produtos:
...
-- 7 - Insira os seguintes registros na tabela produtos:
insert into produtos (nome,descricao,preco,categoria) values 
...
-- 8 - Insira o seguinte registro na tabela info_produtos:
...
-- 9 - Insira o seguinte registro na tabela info_produtos:
...
-- 10 - Insira o seguinte registro na tabela pedidos:
select * from pedidos;
...
-- 11 - Insira o seguinte registro na tabela pedidos:
insert into pedidos (id_cliente,id_funcionario,id_produto,quantidade,data_pedido,status) values
...
-- 12 - Realize um SELECT em todas as tabelas e verifica se os campos de identificação de cada tabela seguem uma ordem numérica sem pular números:
select * from funcionarios;
select * from clientes;
select * from produtos;
select * from info_produtos;
...
--  13 - Atualize o funcionário de CPF 444.555.666-77, com o cargo de 'Garçonete' e salário de 2700.
select * from funcionarios;
update  funcionarios set  cargo='Garçonete' ,salario='2700' where  cpf='444.555.666-77';
select * from funcionarios;

-- 14 - Atualize todos os pedidos com data menor que '2024-07-06' para status como 'Concluído'
select * from pedidos;
update pedidos set status='Concluído' where data_pedido <='2024-07-06';
select * from pedidos;

-- 15 - Remova o funcionário de CPF 222.333.444-55
select * from funcionarios;
